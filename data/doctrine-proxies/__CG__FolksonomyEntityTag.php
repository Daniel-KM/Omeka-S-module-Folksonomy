 ...
 */
class Tag extends \Folksonomy\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'taggings', 'resources', 'owners'];
        }
